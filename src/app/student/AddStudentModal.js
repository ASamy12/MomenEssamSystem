...
export default function AddStudentModal({ open, onClose, onStudentAdded }) {
  ...
  // Fetch centers from the database on modal open
  useEffect(() => {
    if (open) {
      const fetchCenters = async () => {
        try {
          const response = await axios.get("/api/center"); // API endpoint to get centers
          console.log("centerss", response);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onStudentAdded(); // Callback to refresh students after adding
